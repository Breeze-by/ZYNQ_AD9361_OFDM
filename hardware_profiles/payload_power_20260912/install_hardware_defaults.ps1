...
if(!(Select-String -LiteralPath "$diag\stage18-build.log" -Pattern '^STAGE18_BUILD_COMPLETE ' -Quiet)){throw 'Build not complete'}
...
"STAGE18_HARDWARE_EXPORT_INSTALLED BIT=$hash PS_INIT_UNCHANGED=1 BSP_UNCHANGED=1"
