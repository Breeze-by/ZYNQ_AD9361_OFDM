...
S2MM wait id=1 expect=2880 waited_ms=1000 txdone=... rxdone=... tx_irq=... rx_irq=...
S2MM done id=1 len=2880 irq=0x... rx_crc=0x... tx_crc=0x... cmp=OK done=1
S2MM done id=1 len=2880 irq=0x... rx_crc=0x... tx_crc=0x... cmp=DIFF first_diff=...
S2MM rx_head ...
S2MM tx_head ...
S2MM error id=1 irq=0x... errors=1
```
