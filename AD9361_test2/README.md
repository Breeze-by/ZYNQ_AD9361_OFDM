...
TX_BUFFER_WORD_COUNT           131072
TX 缓冲区大小                  1048576 字节

NET_AGG_BLOCK_BYTES            32768
NET_AGG_BLOCK_COUNT            32
聚合缓冲总容量                 1048576 字节
NET_AGG_MIN_FLUSH_BYTES        16384
...
UDP RX ready, agg_blocks=32 block_bytes=32768 total_bytes=1048576 max_payload=32768 rec_window<=64 ack=on_accept
```
